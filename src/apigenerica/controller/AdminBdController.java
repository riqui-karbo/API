...
/**
 * Controlador para operaciones administrativas sobre bases de datos.
 * Permite crear, listar y eliminar BDs, listar tablas, describir estructura,
 * leer datos completos e insertar registros en cualquier tabla de cualquier BD.
 *
 * Estos endpoints permiten que el frontend delegue TODAS las operaciones SQL
 * a la API, en lugar de ejecutar JDBC directamente.
 *
 * @author Grupo1
 */
