-- Backup general generado el 20260519_185341
...
INSERT INTO `erp_meta_columnas` VALUES ('26', '10', 'tao', 'TEXTO_CORTO', '1', '0', '1', '1', '0', '0', '0', NULL);
INSERT INTO `erp_meta_columnas` VALUES ('30', '14', 'Tao', 'TEXTO_CORTO', '1', '0', '1', '1', '0', '0', '0', NULL);
INSERT INTO `erp_meta_columnas` VALUES ('31', '14', 'hola2', 'TEXTO_CORTO', '1', '0', '1', '0', '0', '0', '0', NULL);
...
INSERT INTO `erp_meta_tablas` VALUES ('10', '1', 'riki', 'ricardo');
INSERT INTO `erp_meta_tablas` VALUES ('14', '1', 'draculaura', 'draculaura2');
...
DROP TABLE IF EXISTS `draculaura`;
CREATE TABLE `draculaura` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Tao` varchar(1) DEFAULT NULL,
  `hola2` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `draculaura` VALUES ('1', NULL, 'asd');
...
INSERT INTO `productos_test` VALUES ('1', '[value-2]', '[value-3]');
...
INSERT INTO `prueba123` VALUES ('3', '1234', '1234', NULL);
INSERT INTO `prueba123` VALUES ('4', '123', '123', NULL);
INSERT INTO `prueba123` VALUES ('5', 'a', 'b', NULL);
INSERT INTO `prueba123` VALUES ('6', '1', '2', NULL);
INSERT INTO `prueba123` VALUES ('7', 'a', 'b', NULL);
